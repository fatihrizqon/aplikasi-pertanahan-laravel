...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('bidang', function (Blueprint $table) {
            $table->increments('id');
            $table->smallInteger('id_jenis_hak')->nullable();
            $table->smallInteger('id_jenis_uupa')->nullable();
            $table->string('no_surat_uupa', 64)->nullable();
            $table->string('no_bidang', 64)->notNullable();
            ...
            $table->smallInteger('id_status_kesesuaian')->nullable();
            $table->string('no_sertifikat', 128)->nullable();
            $table->unsignedInteger('id_file')->nullable();
            $table->smallInteger('id_status_sertifikat')->nullable();
            $table->geometry('geom', 'multipolygon', 4326)->nullable();
            $table->unsignedInteger('id_persil')->nullable();
            $table->smallInteger('id_kesesuaian_rdtr')->nullable();
            $table->unsignedInteger('id_peta')->nullable();
            $table->string('id_sg_pag_lama', 256)->nullable();
            $table->string('last_updated', 500)->nullable();
