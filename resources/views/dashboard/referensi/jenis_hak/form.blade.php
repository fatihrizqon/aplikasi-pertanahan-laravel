@php
$action = empty($model->id) ? route('jenis_hak.store') : route('jenis_hak.update', $model->id);
@endphp
    ...
    <div class="modal-body">
        <div class="grid grid-cols-3 items-start gap-4">
            <div class="col-span-1 pt-2">
                <x-input-label for="kode">Kode</x-input-label>
            </div>
            <div class="col-span-2">
                <x-text-input id="kode" class="block w-full" type="text" name="kode" autofocus autocomplete="kode" />
            </div>
        </div>
