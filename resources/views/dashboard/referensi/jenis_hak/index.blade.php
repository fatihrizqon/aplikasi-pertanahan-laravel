@php
$indexHref = route('jenis_hak.index');
$createHref = route('jenis_hak.create');
$updateHref = fn ($model) => route('jenis_hak.edit', $model->id);
$deleteHref = fn ($model) => route('jenis_hak.destroy', $model->id);

$page_title = "Jenis Hak Adat";
$page_subtitle = "Kelola data jenis hak adat.";
@endphp
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap font-normal text-sm text-gray-800 dark:text-neutral-200">
                                        <div class="flex items-center gap-2">
                                            <span class="w-4 h-4 rounded-full border" style="background-color: {{ $model->warna }}"></span>
                                            <span>{{ $model->warna }}</span>
                                        </div>
                                    </td>

                                    <td class="px-6 py-4 whitespace-nowrap text-center font-normal text-sm text-gray-800 dark:text-neutral-200">
                                        @if($model->ontop)
                                        ...
                                        @else
                                        <span class="inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-gray-100 text-gray-800 dark:bg-neutral-700 dark:text-neutral-300">
                                            No
                                        </span>
                                        @endif
                                    </td>
