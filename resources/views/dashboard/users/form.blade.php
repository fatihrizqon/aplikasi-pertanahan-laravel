@php
$action = empty($model->id) ? route('users.store') : route('users.update', $model->id);
@endphp
    ...
    <div class="modal-body">
        <div class="grid grid-cols-3 items-start gap-4">
            ...
            <div class="col-span-2">
                <x-text-input id="username" class="block w-full" type="text" name="username" autofocus autocomplete="username" />
            </div>
        </div>
        ...
        <div class="grid grid-cols-3 items-start gap-4">
            ...
            <div class="col-span-2">
                <x-text-input id="name" class="block w-full" type="text" name="name" autocomplete="name" />
            </div>
        </div>
        ...
        <div class="grid grid-cols-3 items-start gap-4">
            ...
            <div class="col-span-2">
                <x-text-input id="email" class="block w-full" type="email" name="email" autocomplete="username" />
            </div>
        </div>
        ...
        <div class="grid grid-cols-3 items-start gap-4">
            ...
            <div class="col-span-2">
                <x-text-input id="password_confirmation" class="block w-full" type="password" name="password_confirmation" autocomplete="new-password" />
            </div>
        </div>
    </div>
