<x-auth-layout>
    <div class="mt-7 bg-white border border-gray-200 rounded-xl shadow-2xs dark:bg-neutral-900 dark:border-neutral-700">
        <div class="p-4 sm:p-7">
            ...
            <div class="mt-5">
                <form id="form-element" method="POST" action="{{ route('login') }}" enctype="multipart/form-data" >
                    @csrf
                    <div class="grid gap-y-4">
                        <!-- Username or Email -->
                        <div>
                            <x-input-label for="login">Username or Email</x-input-label>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a class="inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 hover:underline focus:outline-hidden focus:underline font-medium dark:text-blue-500" href="{{ route('password.request') }}">Forgot password?</a>
                        </div>
                        <!-- End Checkbox -->
